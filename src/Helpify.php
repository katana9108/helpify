...
class Helpify
{
     ...
     * @param bool $requireSymbols Whether to require symbols.
     *
    ...
    public function isStrongPassword($password, $minLength = 8, $requireUppercase = true, $requireNumbers = true, $requireSymbols = true)
    {
        ...
        // Check for symbols
        if ($requireSymbols && !preg_match('/[!@#$%^&*()-_+=<>?{}[\]]/', $password)) {
            return false;
        }
    ...
    // In AppServiceProvider or a separate helper file

    /**
     * Generate a strong password.
     *
     * @param int $length The length of the password.
     * @param bool $useUppercase Whether to include uppercase letters.
     * @param bool $useNumbers Whether to include numbers.
     * @param bool $useSymbols Whether to include symbols.
     *
